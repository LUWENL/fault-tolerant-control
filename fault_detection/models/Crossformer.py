...
import sys
print(sys.path)
from models.layers.Crossformer_EncDec import scale_block, Encoder, Decoder, DecoderLayer
from models.layers.Embed import PatchEmbedding
from models.layers.SelfAttention_Family import AttentionLayer, FullAttention, TwoStageAttentionLayer
...
class Model(nn.Module):
    ...
    def forward(self, x_enc):
        ...
        return dec_out.unsqueeze(1)  # [B, N]